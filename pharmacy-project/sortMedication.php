...
$command = 'cd java && java -cp ".;' . $jarFile . '" pharmacy_inventory_management_system.SortMedicationRunner';
...
<html>
<head>
    <title>Sorted Medications</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="top-section">
            <div>
                <h2 class="page-title">Medications Sorted by Expiration Date</h2>
                <p class="description">
                    Showing medications sorted using Java Merge Sort.
                </p>
            </div>
            ...
            <table>
                ...
                <?php foreach ($lines as $line) { ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($expiration_date); ?></td>
        ...
        <?php } else { ?>
            ...
            <div class="empty-message">
                No sorted medication results were returned.
            </div>
